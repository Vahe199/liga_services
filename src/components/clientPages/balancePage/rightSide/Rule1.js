    ...
    return (
        <Card sx={{boxShadow: 2}}>
            ...
            <Typography style={{marginBottom: '20px'}} variant={'h4'}>
                За отклик или контакт клиента. Отклик-оплачиваете предложение клиену, затем можете обсуждать детали и договариваться в чате.
                Контакт клиента - бесплатно уточняете условия в чате, платите только при обмене контактами.
            </Typography>
